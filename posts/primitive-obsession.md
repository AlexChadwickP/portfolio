---
title: 'What is Primtive Obsession, and how do you fix it?'
author: 'Alex Chadwick'
date: '2023-02-22T21:47:00.000Z'
isPublished: true
description: "Primitive obsession is an extremely common code smell, and when identified and fix, it greatly helps to reduce the amount of bugs that you may find in your code. This code smell is one that most developers can't intuitively identify."
---
...
In order to know what primitive obsession is about, it's usefult to firstly define primitive types. Primitive types are essentially the **basic building blocks** of a language. These are integers, strings, chars, floating point numbers etc.
